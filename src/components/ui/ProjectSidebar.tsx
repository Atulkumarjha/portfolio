...
export const ProjectSidebar: React.FC<ProjectSidebarProps> = ({ activeProject }) => {
  return (
      ...
      <div className="sticky top-40">
        <div className="flex">
          <div 
            ...
            style={{ backgroundColor: activeProject.shadowColor }}
          />
          <div className="flex flex-col items-start lg:h-[500px] transition-all duration-300">
              ...
              {activeProject.features.map((feature, index) => (
                <li key={index} className="flex items-center text-sm transition-all duration-300">
                  <svg
                    ...
                    style={{ 
                      fill: activeProject.shadowColor,
                      color: activeProject.shadowColor,
                      backgroundColor: `${activeProject.shadowColor}20`
                    }}
                  >
