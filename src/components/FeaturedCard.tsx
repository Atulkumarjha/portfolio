...
const projects = [
  {
    ...
    longDescription: 'A platform designed for early-stage entrepreneurs to pitch, browse, and engage with startup ideas. It\'s built to impress both users and investors with blazing speed, compelling visuals, and a modern tech stack.',
  ...
  },
  {
    ...
    longDescription: 'An innovative educational platform that bridges the gap between students and instructors, offering personalized learning paths, interactive content, and real-time collaboration tools for enhanced educational outcomes.',
  ...
  },
  {
    ...
    longDescription: 'A developer-focused platform for creating, organizing, and sharing code snippets with syntax highlighting, version control, and team collaboration features.',
  ...
  },
  {
    ...
    longDescription: 'A modern, responsive portfolio website showcasing creative web development projects with smooth animations, interactive elements, and cutting-edge design principles.',
  ...
  },
  {
    ...
    longDescription: 'A cutting-edge AI SaaS platform landing page featuring modern design principles, conversion optimization, and seamless user experience to drive engagement and subscriptions.',
