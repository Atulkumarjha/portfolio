...
// Keep your existing NavBarWrapper component
export function NavBarWrapper() {
  ...
  return (
<div className="fixed top-0 left-0 w-full flex justify-center bg-black/70 backdrop-blur-md py-5 px-6 z-50">
      {/* Outer container for logo, navbar, menu button */}
...
// ✅ New named export that wraps NavBarWrapper
