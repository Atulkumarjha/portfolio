...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-10 items-center justify-center rounded-full  bg-white shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className,
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-1">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref}>
              <img src="/assets/avatars/Avatar1.jpeg" alt="My Image" className="h-full w-full object-cover rounded-full" />
              </Circle>
          <Circle ref={div5Ref}>
              <img src="/assets/avatars/Avatar2.jpeg" alt="My Image" className="h-full w-full object-cover rounded-full" />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref}>
              <img src="/assets/avatars/Avatar3.jpeg" alt="My Image" className="h-full w-full object-cover rounded-full" />
          </Circle>
          <Circle ref={div4Ref} className="size-12">
              <img src="/assets/atulkumarjha.jpg" alt="My Image" className="h-15 w-12 object-cover rounded-full" />
          </Circle>
          <Circle ref={div6Ref}>
              <img src="/assets/avatars/Avatar4.jpeg" alt="My Image" className="h-full w-full object-cover rounded-full" />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref}>
              <img src="/assets/avatars/Avatar5.jpeg" alt="My Image" className="h-full w-full object-cover rounded-full" />
          </Circle>
          <Circle ref={div7Ref}>
              <img src="/assets/avatars/Avatar6.jpeg" alt="My Image" className="h-full w-full object-cover rounded-full" />
          </Circle>
        </div>
      </div>
