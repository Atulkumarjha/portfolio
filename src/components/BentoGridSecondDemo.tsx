...
const items = [
  {
    title: "Collaboration",
    description:
      "I excel at collaborating with clients by fostering transparent and open communication.",
    header: <CollaborationCard />,
    className: "md:col-span-2 lg:col-span-2",
    icon: (
      <HeartHandshake className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-neutral-500" />
    ),
  },
  {
  ...
  },
  {
    title: "Remote",
    description:
      "I'm highly flexible and can easily accommodate different time zones for communication.",
    header: (
  ...
  {
    title: "Social Handle",
    description: "Let's Work on your next Project",
    header: (
    ...
    className: "md:col-span-2 lg:col-span-2",
    icon: (
      <IconTableColumn className="h-4 w-4 sm:h-5 sm:w-5 text-neutral-500" />
    ),
  },
];
